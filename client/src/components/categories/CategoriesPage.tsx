...
interface CategoriesPageProps extends RouteComponentProps<any>, React.Props<any> {
  actions: any;
  categories: any[];
}
...
function mapDispatchToProps(dispatch) {
  return {
    actions: bindActionCreators(categoryActions as any, dispatch)
  };
}
const component = connect(mapStateToProps, mapDispatchToProps)(CategoriesPage);
