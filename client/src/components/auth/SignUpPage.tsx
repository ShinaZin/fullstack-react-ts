...
interface SignUpPageProps extends RouteComponentProps<any>, React.Props<any> {
  actions: any;
}
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(SignUpPage) as any);
